...
async function run() {
  try {
    ...
    app.post("/users", async (req, res) => {
      ...
      // you can do this in many ways (1.unique email , 2.upsert ,3. simple checking)
    ...
    app.post("/carts", async (req, res) => {
      ...
      const result = await cartCollection.insertOne(cartBody);
      res.send(result);
    });
    ...
    app.post("/payments", async (req, res) => {
      ...
      // carefully delete each from the cart
...
app.listen(port, () => {
  console.log("restaurant is running in ", port);
});
